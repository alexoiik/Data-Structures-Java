...
η οποία θα υλοποιείται µε ̟πίνακα. Πιο συγκεκριµένα θα εµφανίζεται το παρακάτω µενού:
ΜΕΝΟΥ
1. Άφιξη αυτοκινήτου
...
{  
    public static void main(String args[]) throws IOException
    {
        ...
        ArrayQueue carQueue=new ArrayQueue();
            ...
            switch (choice) 
            {
                ...
                case 3:
                    if(!carQueue.isEmpty())
                    {
                        ...
                        {
                            System.out.println(carQueue.front());
                        }
                    } 
                    else
